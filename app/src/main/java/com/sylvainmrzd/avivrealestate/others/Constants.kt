...
object Constants {
    ...
    const val BACK_BUTTON_TAG = "BACK_BUTTON_TAG"
    const val AD_DETAIL_CONTENT_TAG = "AD_DETAIL_CONTENT_TAG"
    const val AD_DETAIL_PHOTO_TAG = "AD_DETAIL_PHOTO_TAG"
    const val AD_DETAIL_FULLSCREEN_PHOTO_TAG = "AD_DETAIL_FULLSCREEN_PHOTO_TAG"
    const val AD_DETAIL_FULLSCREEN_PHOTO_CLOSE_BUTTON_TAG = "AD_DETAIL_FULLSCREEN_PHOTO_CLOSE_BUTTON_TAG"
